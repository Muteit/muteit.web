					...
					<div class="row">
						...
						<div class="col-md-3">
							<a href="https://t.me/muteitapp" target="_blank" class="bi bi-telegram">
								<i class="fab fa-telegram-plane mr-1"></i>${t('cta-go-to-chat-telegram')}</a>
						</div>
						<div class="col-md-3">
									...
									<div class="col-6">
										<a href="https://t.me/muteitapp" target="_blank" class="text-icon">
											<img src="assets/img/icon_volunteeer.svg"
												alt="Перейти в чат telegram где общаются про социально значимый проект Muteitapp"><span>${t('url-volunteer-text')}</span>
										</a>
									</div>
								</div>
							</div>
